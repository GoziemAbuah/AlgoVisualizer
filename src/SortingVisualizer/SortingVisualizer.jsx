...
// Constants for speed of movement and data comparison 
...
export default class SortingVisualizer extends React.Component{
    ...
    // this function generates new arrays upon clicking
    resetArray(){
    ...
    // merge sort visualizing system, the algorithm can be found in "sortalgorithms" file
    mergeSort() {
    ...
    // takes data input and a "start" and "end" position for the quicksort function
    // partitions the array and compares the data
   ...
   async quickSort(input, start, end) {
    ...
    // used by quicksort to rearrange the array (helper function)
    async sort(){
    ...
    // helper function to develop the array styling
    render(){
...
// helpers for randomizing data and setting speed of comparisons 
